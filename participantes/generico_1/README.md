...
**Bono total por aciertos en Fase de Grupos:** +49 pts

---
### 📌 DIECISEISAVOS.1
| Partido Oficial | Tu Pronóstico | Resultado Real | 1X2 | Exacto | Mult. | Pts |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **República Checa** vs **Suiza** | **3 - 2** | **2 - 3** | ❌ | --- | x2.0 | **0.0** |
| **Ecuador** vs **Corea del Sur** | **1 - 2** | **3 - 0** | ❌ | --- | x1.5 | **0.0** |
| **Países Bajos** vs **Marruecos** | **0 - 2** | **2 - 3** | ✅ | --- | x2.0 | **2.0** |
| **Brasil** vs **Suecia** | **2 - 0** | **3 - 2** | ✅ | --- | x2.0 | **2.0** |
...
| **Portugal** vs **Ghana** | **2 - 3** | **3 - 1** | ❌ | --- | x1.5 | **0.0** |
| **España** vs **Austria** | **2 - 1** | **2 - 1** | ✅ | 🎯 | x1.5 | **6.0** |
| **Canadá** vs **Escocia** | **2 - 1** | **1 - 0** | ✅ | --- | x1.5 | **1.5** |
...
| **Suiza** vs **Marruecos** | **1 - 0** | **1 - 2** | ❌ | --- | x2.0 | **0.0** |
| **Brasil** vs **Noruega** | **2 - 3** | **2 - 1** | ❌ | --- | x1.5 | **0.0** |
| **México** vs **Inglaterra** | **3 - 1** | **2 - 3** | ❌ | --- | x1.0 | **0.0** |
| **Portugal** vs **España** | **0 - 1** | **2 - 3** | ✅ | --- | x2.0 | **2.0** |
| **Estados Unidos** vs **Bélgica** | **0 - 2** | **1 - 3** | ✅ | --- | x2.5 | **2.5** |
...
| Partido Oficial | Tu Pronóstico | Resultado Real | 1X2 | Exacto | Mult. | Pts |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Francia** vs **Marruecos** | **2 - 1** | **2 - 1** | ✅ | 🎯 | x2.5 | **10.0** |
| **España** vs **Bélgica** | **0 - 1** | **3 - 2** | ❌ | --- | x3.0 | **0.0** |
