...
| **Inglaterra** | <br>G  `🟥` ── `░` ── `⚪` ── `░` ── `🟩` ── `📌🎯`  F<br><span style='font-size:0.82em; color:#6b7280;'>Leyenda del eje: **G** (Grupos:0) ➔ **1/16**:1 ➔ **1/8**:2 ➔ **1/4**:3 ➔ **Semis**:4 ➔ **F** (Final:5) \| Media del Grupo: **1.67**</span> | 🟢 **+5 Pts**<br>🔥 ¡Sorpresa! |
