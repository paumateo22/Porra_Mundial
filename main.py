...
def mostrar_menu():
    while True:
        ...
        print("  6. 🎨 Generar Vistas GitHub (07)")

        print("\n--- 📊 FASE 3: VISUALIZACIÓN ---")
        print("  7. 🎨 Generar Vistas Web (07b1-4 + 07b5 + 07b6 + 07b7 + 07b8)")
        ...
        if opcion == "1":
            ...
            if ejecutar_script("07b1_html_instrucciones.py"):
                ejecutar_script("07b2_html_participantes.py")
                ...
                ejecutar_script("07b8_html_jornadas.py")
        elif opcion == "9":
                        ...
                        if ejecutar_script("06c_motor_fase_grupos.py"):
                            if ejecutar_script("06e_motor_sorpresas.py"):
                                if ejecutar_script("06f_motor_premios.py"):
                                    if ejecutar_script("06d_motor_cierre.py"):
                                        if ejecutar_script("07_generador_vistas.py"):
                                            ejecutar_script("07b1_html_instrucciones.py")
                                            ejecutar_script("07b2_html_participantes.py")
                                            ejecutar_script("07b3_html_calendario.py")
                                                ...
                                                if ejecutar_script("07b5_html_dashboards.py"):
                                                    if ejecutar_script("07b6_html_pronosticos.py"):
                                                        if ejecutar_script("07b7_html_generador.py"):
                                                            if ejecutar_script("07b8_html_jornadas.py"):
